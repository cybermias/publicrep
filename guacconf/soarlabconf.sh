...
# UPDATED AT 20190901 - Following CSP3 class (YOSSI - Bridge) - Especially for SOARLAB by Holistic.
#
# Specified to work with SoarLab ORG.
...
for ((i=0; i<$#; i+=3))
{
	...
	'RDPadmin')
	    ...
	    <param name="domain">soarlab</param>
            ...
            <param name="username">baruchs</param>
            <param name="password">barSoar12#</param>
	...
	;;
  	...
  	'RDPadam')
        ...
        <connection name="$vmName [RDP]">
            ...
            <param name="port">3389</param>
	    <param name="domain">soarlab</param>
            <param name="username">adams</param>
            <param name="password">adaSoar12#</param>
            <param name="ignore-cert">true</param>
            <param name="security">any</param>
        </connection>
EOF
...
EOF
	...
	'SSHossim')
        ...
        <connection name="$vmName [SSH]">
            ...
            <param name="password">soarAdmin12#</param>
        </connection>
EOF
	;;
