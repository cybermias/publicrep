...
# Guacamole was updated to V1.1.0 (and openvpn to 2.7.5). Apperantly, "service guacd restart" no longer works.
# New server will only restart guacd with systemctl.
