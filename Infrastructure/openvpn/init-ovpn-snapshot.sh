...
sudo echo 'sudo sqlite3 "/usr/local/openvpn_as/etc/db/config.db" "update config set value='"'"'$vnetfix'"'"' where name='"'"'vpn.server.routing.private_network.0'"'"';"' >> /etc/init.d/fixvpnpip.sh
