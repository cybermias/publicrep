...
$winlogbeatScript = $winlogbeatFolder+'install-service-winlogbeat.ps1'
& $winlogbeatScript

$winlogbeatYml = $winlogbeatFolder+"winlogbeat.yml"
...
Start-Process $($winlogbeatFolder+"winlogbeat.exe") 'setup -e'
